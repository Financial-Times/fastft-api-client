...
curl -sG 'http://clamo.ftdata.co.uk/api'  -o 'test/stubs/search.json' --data-urlencode 'request=[{"action":"search","arguments":{"sort":"date","outputfields":'$OUTPUT_FIELDS',"query":"status:live","offset":0,"limit":10,"suppressdrafts":false}}]'
